...
1. Randomly (-gff = NA): This option will call `mock_gff` to 
...
sim_means_gff <- splatPopSimulateMeans(vcf = vcf, params = params, gff=gff)
...
plotPCA(sim_sc_gr2$sc, colour_by = "Group", shape_by = "Sample")
```
