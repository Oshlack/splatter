...
distribution derived from real single cell data by `splatEstimate`. Finally,
...
parameters were estimated from the thyroid data and eQTL 
mapping results from GTEx. You can estimate these parameters from your own bulk and 
