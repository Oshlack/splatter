...
data using `simpleEstimate()` and to simulate data using that simulation you
...
`?lun2Estimate` for for information of how the Lun 2 simulation estimates
