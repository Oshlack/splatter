...
plotPCA(sim.pop.paths, colour_by = "Step", ncomponents=5)
...
plotPCA(sim.pop.batches, colour_by = "Batch", ncomponents=5)
...
sim.pop.3 <- splatSimulateeQTL(eqtl = eqtl3, params = params, batchCells= 300)
...
ggplot(both, aes(x=genotype, y=count, fill = type)) +
